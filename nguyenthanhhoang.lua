shared.LoaderTitle = "NGUYEN THANH HOANG ";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://97914355499852",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=97914355499852";
v24.Parent = v23;
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "bật haki triệu hồi rip_india ",
    Description = "",
    Default = false
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("xương hiện tại': " .. tostring(v768) .. " Xương");
            end
        end);
    end);
...
if Sea3 then
    local v490 = v16.Main:AddSection("Katakuri v1");
        ...
        while wait() do
            pcall(function()
                ...
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                    ...
                    v491:SetDesc("Katakuri v1: ✅️");
                end
            end);
        end
    end);
    local v492 = v16.Main:AddToggle("ToggleCake", {
        Title = "Cày katakuri v1",
        Description = "",
        Default = false
    });
    local v493 = true;
...
if Sea3 then
    ...
    v16.Sea:AddButton({
        ...
        Description = "Tự động ngồi vào thuyền",
        Callback = function()
            v521();
        end
    });
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Bay Đến Npc bán trái trên đảo",
    Description = "",
    Default = false
});
